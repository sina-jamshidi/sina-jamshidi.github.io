    ...
    return (
        <main className="min-h-screen bg-gradient-to-b from-slate-300 to-slate-400 p-8">
            ...
            <h3 className="text-xl font-medium text-slate-600 max-w-2xl mx-auto leading-relaxed mb-6">
                Trusted by the world's coolest people and funnest companies to
                build meaningful products
            </h3>
            <div className="max-w-2xl place-self-center mb-6">
                <Marquee
                    pauseOnHover
                    className="[--duration:20s] max-w-[100vw]"
                >
                    <div className="flex items-center gap-8 mr-4">
                        <a
                            href="https://tanium.com"
                            target="_blank"
                            rel="noreferrer"
                        >
                ...
                <div className="space-y-4">
                    <div className="bg-white/50 backdrop-blur-sm rounded-lg p-4 shadow-sm">
                        ...
                        <p className="text-slate-600 mb-3">
                            I work on the platform team to build and maintain
                            features for admins to manage their organization.
                        </p>
                    ...
                    <div className="bg-white/50 backdrop-blur-sm rounded-lg p-4 shadow-sm">
                        ...
                        <p className="text-slate-600 mb-3">
                            As part of the Infrastructure and Integration team,
                            built an end to end integration ecosystem, allowing
                            manual and automated data ingestion and export at
                            scale. Collaborated in a small team on the
                            infrastructure of greenfield project to enable
                            customers to stream events to 3rd party
                            destinations, contributing to important{" "}
                            <a
                    ...
                    <div className="bg-white/50 backdrop-blur-sm rounded-lg p-4 shadow-sm">
                        ...
                        <p className="text-slate-600 mb-3">
                            Worked in a team of 6 on cross-platform mobile app
                            for the Smart Activity Sensor. Developed in C# on
                            Xamarin. Personally worked on custom UI, BLE and
                            Wi-Fi connectivity, and a caching module.
                        </p>
                        <div className="flex flex-wrap gap-2">
                            <span className="px-2 py-1 bg-slate-200 rounded-md text-sm text-slate-700">
                                C#
                    ...
                    <div className="bg-white/50 backdrop-blur-sm rounded-lg p-4 shadow-sm">
                        ...
                        <p className="text-slate-600 mb-3">
                            Worked on two projects. The AI-education kit in
                            Python and Keras. In a team of 2, designed and
                            implemented deep learning projects. For the other
                            project, individually designed and built an AI car
            ...
            <section className="max-w-2xl mx-auto mb-12">
                ...
                <div className="space-y-4 mb-4">
                    <div className="bg-white/50 backdrop-blur-sm rounded-lg p-4 shadow-sm">
                        ...
                        <p className="text-slate-600 mb-3">
                            A workflow automation tool utilizing LLMs to
                            generate tables and text based on chained prompts.{" "}
                            <a
                            ...
                            >
                                Achieved "5th Product of the Day" and "4th SaaS
                    ...
                    <div className="bg-white/50 backdrop-blur-sm rounded-lg p-4 shadow-sm">
                        ...
                        <p className="text-slate-600 mb-3">
                            A directory of social games to play with friends.
                            Allows a variety of filtering on names, tags, and
                            multiplayer player count. Used scraping and data
                            cleaning to come up with the list of games and to
                ...
                <div className="space-y-4">
                    <div className="bg-white/50 backdrop-blur-sm rounded-lg p-4 shadow-sm">
                        ...
                        <p className="text-slate-600 mb-3">
                            I was tasked individually with creating a hands-on,
                            AI based project. I designed and implemented a
                            multi-threaded algorithm that drives a robot around
                            until it detects a person, and then chases them and
                            celebrates when it catches up to them. It will also
                            perform obstacle avoidance with an ultrasonic
                            sensor, and is written in modular code to be
                            customizable.
                        </p>
                    ...
                    <DockIcon>
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <a
                                    href="mailto:hello@sinajamshidi.com"
                                    target="_blank"
                                >
